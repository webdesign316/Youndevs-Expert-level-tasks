...
if __name__ == "__main__": 
    ...
    multiply = Button(gui, text=' * ', fg='black', bg='blue',command=lambda: press("*"), height=1, width=7) 
    ...
    Decimal= Button(gui, text='.', fg='black', bg='blue', command=lambda: press('.'), height=1, width=7) 
